  ...
  <div id="app" :style="appShellCssVars">
    ...
    >
      <span class="security-warning-text">
        ...
        app is exposed to the internet, enable Bookmarkarr authentication or protect it with reverse
    ...
    >
      ...
      >
        <nav class="sidebar-nav" @click.capture="onNavCapture">
          <div class="nav-section">
            ...
            >
              ...
              <RouterLink to="/library/import/goodreads" class="nav-subitem" @click="closeMobileMenu">
                <span>Import · Goodreads</span>
              </RouterLink>
              <RouterLink to="/library-import" class="nav-subitem" @click="closeMobileMenu">
        ...
        <div v-if="version && version.length > 0" class="sidebar-footer">
          ...
          <a
            href="https://github.com/gitsumhubs/Bookmarkarr"
            target="_blank"
