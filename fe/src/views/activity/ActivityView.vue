      ...
      <div class="modal-content" @click.stop>
        ...
        <div class="modal-body">
          ...
          <p v-else>
            ...
            remove it from Bookmarkarr only (this will delete the record from Bookmarkarr's downloads)?
          </p>
          ...
          <p class="warning-text" v-else>
            ...
            delete the Bookmarkarr record (no action will be taken against the remote client).
          </p>
        </div>
