...
const RESULTS_KEY = 'bookmarkarr.addNewResults'
const SEARCH_TYPE_KEY = 'bookmarkarr.addNewSearchType'
const TITLE_RESULTS_COUNT_KEY = 'bookmarkarr.addNewTitleResultsCount'
const ASIN_FILTERING_KEY = 'bookmarkarr.addNewAsinFiltering'
const RESOLVED_ASINS_KEY = 'bookmarkarr.addNewResolvedAsins'
const ADDED_ASINS_KEY = 'bookmarkarr.addNewAddedAsins'
const ADDED_OLIDS_KEY = 'bookmarkarr.addNewAddedOLIDs'
