...
<template>
  <div class="login-page">
    <div class="login-card" role="main" aria-labelledby="login-title">
      <img :src="logoUrl" alt="Bookmarkarr" class="login-logo" />
...
export default defineComponent({
  ...
  setup() {
    ...
    // Keep the login brand consistent with the canonical README/app mark.
    const logoUrl = '/bookmarkarr-logo.png'
    ...
    async function onSubmit() {
      ...
      try {
        ...
        if (!queryRedirect || queryRedirect === '/') {
          try {
            const pending = sessionStorage.getItem('bookmarkarr_pending_redirect') ?? undefined
