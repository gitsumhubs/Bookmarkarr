            ...
            >
              ...
              <div class="audiobook-poster-container" :class="{ 'show-details': showItemDetails }">
                ...
                <div class="status-overlay">
                  ...
                  <div v-if="audiobook.editions?.length" class="edition-badges">
                    <span
                      v-for="edition in audiobook.editions"
                      :key="edition.id"
                      class="edition-badge"
                      :class="{ unmonitored: !edition.monitored, wanted: edition.wanted }"
                    >{{ edition.mediaType === 'Audiobook' ? 'Audio' : 'Ebook' }} · {{ edition.status }}</span>
                  </div>
                </div>
                <div class="action-buttons">
                  <button
...
const SEARCH_QUERY_KEY = 'bookmarkarr.searchQuery'
...
const CUSTOM_FILTERS_KEY = 'bookmarkarr.customFilters'
...
// Grouping mode
const GROUP_BY_KEY = 'bookmarkarr.groupBy'
...
const VIEWMODE_KEY = 'bookmarkarr.viewMode'
...
const SHOW_ITEM_DETAILS_KEY = 'bookmarkarr.showItemDetails'
...
.edition-badge.wanted { background: rgba(255, 91, 66, 0.22); color: #ffad9f; }
.edition-badge.unmonitored { opacity: 0.58; }
</style>
