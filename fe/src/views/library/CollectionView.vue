  ...
  try {
    ...
    if (!refreshedCatalog && !refreshedLookup) {
      toast.error(
        ...
        'Bookmarkarr kept the existing author details because the refresh could not complete.',
      )
      return
    }
  ...
  try {
    ...
    if (!refreshedCatalog && !refreshedLookup) {
      toast.error(
        ...
        'Bookmarkarr kept the existing series details because the refresh could not complete.',
      )
      return
    }
