...
describe('useAdvancedSearch', () => {
  ...
  describe('initialization', () => {
    ...
    it('restores persisted state from localStorage', () => {
      ...
      localStorageMock['bookmarkarr.addnew.advanced'] = JSON.stringify(savedState)
    ...
    it('handles corrupted localStorage data gracefully', () => {
      localStorageMock['bookmarkarr.addnew.advanced'] = 'invalid json'
  ...
  describe('toggleAdvancedSearch', () => {
    ...
    it('persists visibility change', () => {
      ...
      const saved = localStorageMock['bookmarkarr.addnew.advanced']
  ...
  describe('clearPersistedState', () => {
    it('removes state from localStorage', () => {
      ...
      expect(localStorageMock['bookmarkarr.addnew.advanced']).toBeDefined()

      clearPersistedState()

      expect(localStorageMock['bookmarkarr.addnew.advanced']).toBeUndefined()
    })
  ...
  describe('localStorage debouncing', () => {
    it('debounces rapid parameter changes', () => {
      ...
      expect(setItemSpy).toHaveBeenCalledTimes(1)
      const saved = JSON.parse(localStorageMock['bookmarkarr.addnew.advanced'])
  ...
  describe('error handling', () => {
    ...
    it('handles null stored state gracefully', () => {
      localStorageMock['bookmarkarr.addnew.advanced'] = 'null'
