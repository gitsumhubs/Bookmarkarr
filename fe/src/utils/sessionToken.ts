...
class SessionTokenManager {
  private static readonly STORAGE_KEY = 'bookmarkarr_session_token'
  private static readonly PERSISTENCE_MODE_KEY = 'bookmarkarr_session_token_persistence'
  private static readonly EVENT_KEY = 'bookmarkarr_session_event'
