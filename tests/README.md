...
This project is used to test Bookmarkarr backend
...
│   ├── Api/                        # bookmarkarr.api tests

│   ├── Application/                # bookmarkarr.application tests

│   ├── Domain/                     # bookmarkarr.domain tests

│   └── Infrastructure/             # bookmarkarr.infrastructure tests

├── Mocks/                          # Mock definitions

│   └── Api/                        # API mock definitions

├── Bookmarkarr.Tests.csproj          # Testing project
