...
using Bookmarkarr.Infrastructure.Downloads.DirectDownload;
using Bookmarkarr.Infrastructure.HostedServices;
...
namespace Bookmarkarr.Tests.Builders
{
    ...
    public class ServiceCollectionBuilder
    {
        ...
        private ServiceCollection BuildServices()
        {
            ...
            services.AddSingleton(new EphemeralDataProtectionProvider().CreateProtector("Bookmarkarr.ConfigurationService.ProwlarrImport"));
