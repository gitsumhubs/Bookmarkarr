...
{
    public class ProwlarrEndpointsTests : IClassFixture<BookmarkarrWebApplicationFactory>
    {
        private readonly BookmarkarrWebApplicationFactory _factory;

        public ProwlarrEndpointsTests(BookmarkarrWebApplicationFactory factory)
        {
            _factory = factory;
        }
