...
namespace Bookmarkarr.Tests.Features.Api.Features.Search
{
    public class SearchControllerTests
    {
        ...
        public async Task SearchAudibleByTitleAndAuthor_ReturnsResults_WhenTitleProvided()
        {
            ...
            var mamResult = new Bookmarkarr.Domain.Search.IndexerSearchResult
            {
                Id = "28972",
                Title = "Frank Herbert - Collection by Frank Herbert [ENG / MP3] [VIP]",
                Size = 3972844800,
            ...
            mockService2.Setup(s => s.SearchIndexerResultsAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string?>(), It.IsAny<SearchRequest?>())).ReturnsAsync(new List<Bookmarkarr.Domain.Search.IndexerSearchResult> { mamResult });
            ...
            mockService3.Setup(s => s.SearchIndexerResultsAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string?>(), It.IsAny<SearchRequest?>())).ReturnsAsync(new List<Bookmarkarr.Domain.Search.IndexerSearchResult>());
