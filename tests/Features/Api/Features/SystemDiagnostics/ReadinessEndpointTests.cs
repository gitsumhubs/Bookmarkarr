...
namespace Bookmarkarr.Tests.Features.Api.Features.SystemDiagnostics;

public sealed class ReadinessEndpointTests(BookmarkarrWebApplicationFactory factory)
    : IClassFixture<BookmarkarrWebApplicationFactory>
{
    [Fact]
