...
using Bookmarkarr.Api.Dtos.ManualImport;
...
namespace Bookmarkarr.Tests.Features.Api.Features.Downloads
{
    public class ManualImport_MultiFileCollisionTests : IDisposable
    {
        ...
        {
            var basePath = CreateTempDirectory("bookmarkarr-manual-batch");
            var srcDir = CreateTempDirectory("bookmarkarr-manual-src");
        ...
        {
            var basePath = CreateTempDirectory("bookmarkarr-manual-ordered");

            var book = new Audiobook { Id = 84, Title = "Ordered Book", BasePath = basePath };

            var srcDir = CreateTempDirectory("bookmarkarr-manual-ordered-src");
        ...
        {
            var basePath = CreateTempDirectory("bookmarkarr-manual-foreword");
            var srcDir = CreateTempDirectory("bookmarkarr-manual-foreword-sr");
        ...
        {
            var outputRoot = CreateTempDirectory("bookmarkarr-manual-scan-root");
            var srcDir = CreateTempDirectory("bookmarkarr-manual-scan-src");
        ...
        {
            var destinationRoot = CreateTempDirectory("bookmarkarr-manual-companion-dest");
            var sourceDir = CreateTempDirectory("bookmarkarr-manual-companion-src");
        ...
        {
            var destinationRoot = CreateTempDirectory("bookmarkarr-manual-mixed-dest");
            var sourceDir = CreateTempDirectory("bookmarkarr-manual-mixed-src");
        ...
        {
            var basePath = CreateTempDirectory("bookmarkarr-manual-neutral-dst");
            var srcDir = CreateTempDirectory("bookmarkarr-manual-neutral-src");
