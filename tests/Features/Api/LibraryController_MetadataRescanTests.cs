...
{
    public class LibraryController_MetadataRescanTests : IClassFixture<BookmarkarrWebApplicationFactory>
    {
        private readonly BookmarkarrWebApplicationFactory _factory;

        public LibraryController_MetadataRescanTests(BookmarkarrWebApplicationFactory factory)
        {
            _factory = factory;
        }
