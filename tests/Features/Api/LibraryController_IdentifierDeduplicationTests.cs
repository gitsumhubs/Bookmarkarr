...
{
    public class LibraryController_IdentifierDeduplicationTests : IClassFixture<BookmarkarrWebApplicationFactory>
    {
        private readonly BookmarkarrWebApplicationFactory _factory;

        public LibraryController_IdentifierDeduplicationTests(BookmarkarrWebApplicationFactory factory)
        {
            _factory = factory;
        }
