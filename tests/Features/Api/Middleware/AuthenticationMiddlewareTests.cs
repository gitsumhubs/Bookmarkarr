...
namespace Bookmarkarr.Tests.Features.Api.Middleware
{
    public class AuthenticationMiddlewareTests : IClassFixture<BookmarkarrWebApplicationFactory>
    {
        private readonly BookmarkarrWebApplicationFactory _factory;

        public AuthenticationMiddlewareTests(BookmarkarrWebApplicationFactory factory)
        {
            _factory = factory;
        }
