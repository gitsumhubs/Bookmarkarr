...
namespace Bookmarkarr.Tests.Features.Api.Common;

public sealed class BookmarkarrExceptionHandlerTests
{
    [Theory]
    ...
    public async Task TypedExceptions_MapToStableProblemDetails(string kind, int expectedStatus)
    {
        ...
        problemDetailsService
            ...
            .ReturnsAsync(true);
        var handler = new BookmarkarrExceptionHandler(
            new TestHostEnvironment(Environments.Production),
            NullLogger<BookmarkarrExceptionHandler>.Instance,
        ...
        BookmarkarrApplicationException exception = kind switch
        {
    ...
    private sealed class TestHostEnvironment(string environmentName) : IHostEnvironment
    {
        ...
        public string ApplicationName { get; set; } = "Bookmarkarr.Tests";
