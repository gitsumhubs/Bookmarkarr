...
namespace Bookmarkarr.Tests.Features.Infrastructure.Notifications.Discord
{
    public class DiscordBotServiceTests
    {
        ...
        {
            // Arrange
            var tempRoot = Path.Join(Path.GetTempPath(), "bookmarkarr_test_discord_" + Guid.NewGuid().ToString("N"));
