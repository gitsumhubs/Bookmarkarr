...
namespace Bookmarkarr.Tests.Features.Infrastructure.Notifications.Delivery
{
    public partial class NotificationServiceTests
    {
        ...
        public void CreateDiscordPayload_IncludesTitleAuthorAndThumbnail_WhenAsinAndBaseProvided()
        {
            ...
            var baseUrl = "https://bookmarkarr.example.com";
            ...
            Assert.Equal("https://bookmarkarr.example.com/api/v1/images/B00TEST", thumb["url"]?.ToString());
        }
    }
    ...
    public partial class NotificationServiceTests
    {
        ...
        public void CreateDiscordPayload_ConvertsRelativeImageUrlToAbsolute_WhenBaseUrlProvided()
        {
            ...
            Assert.Equal("https://bookmarkarr.example.com/api/v1/images/B123RELATIVE", image["url"]?.ToString());
        }
    }
    ...
    public partial class NotificationServiceTests
    {
        ...
        {
            var ctx = new RequestContextSnapshot(null, "https", "bookmarkarr.example.com", null, false);

            var baseUrl = NotificationPayloadBuilder.GetBaseUrlFromRequestContext(ctx);
            Assert.Equal("https://bookmarkarr.example.com", baseUrl);
        }
        ...
        public void CreateDiscordPayload_UsesDerivedBaseForThumbnail_WhenProvided()
        {
            ...
            var thumb = RequireProperty(embed, "thumbnail").AsObject();
            Assert.Equal("https://bookmarkarr.example.com/api/v1/images/B123DERIVE", thumb["url"]?.ToString());
        }
    ...
    public partial class NotificationServiceTests
    {
        ...
        public async Task SendNotificationAsync_PostsCorrectJsonToDiscordWebhook()
        {
            ...
            var startupConfig = new StartupConfig { UrlBase = "https://bookmarkarr.example.com" };
            mockConfigService
    ...
    public partial class NotificationServiceTests
    {
        ...
        public async Task SendNotificationAsync_AttachesImageAndReferencesAttachmentInPayload()
        {
            ...
            var data = new
            {
                ...
                asin = "BATTACH",
                imageUrl = "https://bookmarkarr.example.com/api/v1/images/BATTACH.jpg"
            };
