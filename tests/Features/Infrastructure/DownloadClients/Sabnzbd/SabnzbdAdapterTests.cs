...
using Bookmarkarr.Tests.Mocks.Api;


namespace Bookmarkarr.Tests.Features.Infrastructure.DownloadClients.Sabnzbd
{
    public class SabnzbdAdapterTests : BaseTests
    {
        ...
        /// <summary>
        /// Regression test retained from upstream issue 631.
        ...
        {
            var sourceDirectory = FileService.GetTempDirectory("bookmarkarr-test");
            var destinationDirectory = FileService.GetTempDirectory("bookmarkarr-destination");
