...
using Bookmarkarr.Infrastructure.Torrents;

namespace Bookmarkarr.Tests.Features.Infrastructure.DownloadClients.Qbittorrent
{
    public class QbittorrentAdapterTests : BaseTests
    {
        ...
        public async Task MarkItemAsImportedAsync_SetsConfiguredPostImportCategory()
        {
            ...
            {
                ["postImportCategory"] = "bookmarkarr-imported"
            };
            ...
            Assert.Equal("bookmarkarr-imported", form["category"]);
        }
