...
namespace Bookmarkarr.Tests.Features.Infrastructure.DependencyInjection
{
    public class HostedServicesRegistrationTests
    {
        ...
        [Fact]
        public void AddBookmarkarrHostedServices_RegistersHostedServicesAndSingletons()
        {
            // Arrange
            ...
            // Act
            services.AddBookmarkarrHostedServices(config);
        ...
        [Fact]
        public void AddBookmarkarrHostedServices_DoesNotRegisterHostedServiceTwice()
        {
            var services = new ServiceCollection();
            var config = new ConfigurationBuilder().AddInMemoryCollection().Build();
