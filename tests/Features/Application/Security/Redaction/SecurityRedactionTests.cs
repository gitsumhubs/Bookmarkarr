...
namespace Bookmarkarr.Tests.Features.Application.Security.Redaction
{
    public class SecurityRedactionTests
    {
        ...
        public async Task NotificationService_LogsAreRedacted_WhenResponseContainsSensitiveValue()
        {
            ...
            Environment.SetEnvironmentVariable("BOOKMARKARR_API_KEY", secret);
            ...
            mockConfigService.Setup(x => x.GetStartupConfigAsync()).ReturnsAsync(new StartupConfig { UrlBase = "https://bookmarkarr.example.com" });
