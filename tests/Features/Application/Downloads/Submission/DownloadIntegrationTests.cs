...
namespace Bookmarkarr.Tests.Features.Application.Downloads.Submission
{
    public class DownloadIntegrationTests : BaseTests
    {
        ...
        public async Task IndexerToClientToImport_Works_ForSingleAndMultiFile(
            ...
            bool isMultiFile)
        {
            var outputRoot = FileService.GetTempDirectory("bookmarkarr-e2e-out");
            var sourceRoot = FileService.GetTempDirectory("bookmarkarr-e2e-src");
