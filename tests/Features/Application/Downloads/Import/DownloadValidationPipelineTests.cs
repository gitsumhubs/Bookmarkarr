...
namespace Bookmarkarr.Tests.Features.Application.Downloads.Import
{
    ...
    {
        private readonly BookmarkarrDbContext _context;
        ...
        public DownloadValidationPipelineTests()
        {
            ...
            _context = new BookmarkarrDbContext(options);
            ...
            _testDirectory = Path.Join(Path.GetTempPath(), "bookmarkarr_pipeline_test_" + Guid.NewGuid().ToString("N"));
