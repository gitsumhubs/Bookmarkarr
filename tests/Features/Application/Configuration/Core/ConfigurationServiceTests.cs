...
namespace Bookmarkarr.Tests.Features.Application.Configuration.Core
{
    ...
    public class ConfigurationServiceTests : BaseTests
    {
        ...
        public async Task SaveApplicationSettings_PersistsChanges()
        {
            ...
            services.AddLogging();
            services.AddDbContext<BookmarkarrDbContext>(opts => opts.UseInMemoryDatabase(Guid.NewGuid().ToString()));
