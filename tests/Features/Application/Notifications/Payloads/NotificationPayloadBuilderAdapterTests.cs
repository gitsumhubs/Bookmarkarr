...
namespace Bookmarkarr.Tests.Features.Application.Notifications.Payloads
{
    public class NotificationPayloadBuilderAdapterTests
    {
        ...
        public async Task CreateDiscordPayloadWithAttachmentAsync_DownloadsImageAndReturnsAttachment()
        {
            ...
            // Act
            var (payload, attachment) = await adapter.CreateDiscordPayloadWithAttachmentAsync("book-added", data, "https://bookmarkarr.example.com", httpClient, Mock.Of<IRequestContextAccessor>());
