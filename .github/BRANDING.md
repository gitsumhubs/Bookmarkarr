# Bookmarkarr Branding Assets

This document describes the Bookmarkarr brand identity and logo usage guidelines.
...
The Bookmarkarr logo combines three key elements that represent the core functionality:
...
<img src="/icon.png" alt="Bookmarkarr" class="brand-logo" />

<!-- Full logo for headers/splash screens -->
<img src="/logo.png" alt="Bookmarkarr" />
```
...
```markdown
![Bookmarkarr Logo](.github/logo-full.png)
```
