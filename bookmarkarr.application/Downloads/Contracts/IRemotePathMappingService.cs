...
/// <summary>
/// Service for managing remote path mappings between download clients and Bookmarkarr.
/// Used to translate file paths when download clients are in different containers/systems
/// with different mount points than Bookmarkarr.
/// </summary>
public interface IRemotePathMappingService
{
    ...
    /// <summary>
    /// Translate a remote path from a download client to a local path for Bookmarkarr.
