...
namespace Bookmarkarr.Api.Middleware;
    ...
    ILogger<RequestTelemetryMiddleware> logger)
{
    ...
    private static readonly Meter Meter = new("Bookmarkarr.Api");
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        Activity.Current?.SetTag("bookmarkarr.correlation_id", correlationId);
