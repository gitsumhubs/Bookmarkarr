...
Please do NOT check-in or bundle FFmpeg/ffprobe binaries in this repository. Instead, install ffmpeg/ffprobe on the host system and ensure `ffprobe` is available on the PATH for the user running the Bookmarkarr service.
