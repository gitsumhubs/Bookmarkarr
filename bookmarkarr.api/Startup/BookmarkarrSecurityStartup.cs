...
public static class BookmarkarrSecurityStartup
{
    public static IServiceCollection AddBookmarkarrSecurity(
        ...
        IFileSystem fileSystem)
    {
        ...
        services.AddDataProtection()
            ...
            .SetApplicationName("Bookmarkarr");

        return services;
    }

    public static WebApplication UseBookmarkarrSecurityMiddleware(this WebApplication app)
    {
