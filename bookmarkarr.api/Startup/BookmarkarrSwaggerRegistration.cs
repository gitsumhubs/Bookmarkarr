...
public static class BookmarkarrSwaggerRegistration
{
    public static IServiceCollection AddBookmarkarrSwagger(
        ...
        IFileSystem fileSystem)
    {
        ...
        services.AddSwaggerGen(options =>
        {
            ...
            {
                "REST API for Bookmarkarr audiobook management and automation.",
                ...
                "   - The browser stores the `bookmarkarr_session` HttpOnly cookie automatically when `authType` is `session`.",
