...
namespace Bookmarkarr.Api.Features.Identity
{
    [ApiController]
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login([FromBody] LoginRequest req)
        {
            ...
            Response.Cookies.Append("bookmarkarr_session", sessionToken, new CookieOptions
            {
                HttpOnly = true,
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            try
            {
                ...
                Response.Cookies.Delete("bookmarkarr_session", new CookieOptions
                {
                    HttpOnly = true,
                    Secure = HttpContext.Request.IsHttps,
                    SameSite = SameSiteMode.Strict,
        ...
        private static string? ExtractSessionToken(HttpContext context)
        {
            ...
            var cookieToken = context.Request.Cookies["bookmarkarr_session"];
