...
namespace Bookmarkarr.Api.Features.Notifications
{
    [ApiController]
        ...
        public async Task<ActionResult<object>> TestNotification()
        {
            try
            {
                ...
                var testData = new
                {
                    ...
                    asin = "B000TEST",
                    description = "This is a test notification from Bookmarkarr to verify your webhook configuration is working correctly.",
                    message = "This is a test notification from Bookmarkarr",
