...
namespace Bookmarkarr.Api.Features.SystemDiagnostics
{
    [ApiController]
        ...
        public ActionResult DownloadLogs()
        {
            try
            {
                ...
                if (_fileSystem.FileExists(logFilePath))
                {
                    ...
                    var fileName = $"bookmarkarr-logs-{DateTime.UtcNow:yyyy-MM-dd-HHmmss}.log";
                ...
                logContent.AppendLine($"Bookmarkarr Log Export - {DateTime.UtcNow:yyyy-MM-dd HH:mm:ss} UTC");
                ...
                var generatedFileName = $"bookmarkarr-logs-{DateTime.UtcNow:yyyy-MM-dd-HHmmss}.log";
