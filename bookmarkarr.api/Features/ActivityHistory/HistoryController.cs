...
namespace Bookmarkarr.Api.Features.ActivityHistory
{
    [ApiController]
    ...
    public class HistoryController : ControllerBase
    {
        ...
        /// <param name="editionId">Optional physical edition filter.</param>
        /// <param name="mediaType">Optional media filter: audiobook or ebook.</param>
