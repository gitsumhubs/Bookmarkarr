...
namespace Bookmarkarr.Api.Features.Configuration
{
    [ApiController]
    ...
    public class StartupConfigurationController : ControllerBase
    {
        ...
        /// <summary>
        /// Get the full Bookmarkarr startup configuration (API key, authentication, etc).
        /// </summary>
        ...
        /// <summary>
        /// Save the Bookmarkarr startup configuration (API key, authentication, etc).
        /// </summary>
