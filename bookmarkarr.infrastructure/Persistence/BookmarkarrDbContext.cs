...
using Bookmarkarr.Infrastructure.Persistence.Configurations;

namespace Bookmarkarr.Infrastructure.Persistence
{
    public class BookmarkarrDbContext : DbContext
    {
        public DbSet<Audiobook> Audiobooks { get; set; } = null!;
        public DbSet<BookEdition> BookEditions { get; set; } = null!;
        public DbSet<EditionFile> EditionFiles { get; set; } = null!;
        public DbSet<CatalogImportBatch> CatalogImportBatches { get; set; } = null!;
        ...
        public BookmarkarrDbContext(DbContextOptions<BookmarkarrDbContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(BookmarkarrDbContext).Assembly);
            ...
            modelBuilder.Entity<Audiobook>().HasIndex(a => a.GoodreadsId).IsUnique();
            modelBuilder.Entity<BookEdition>().HasIndex(e => new { e.BookId, e.MediaType }).IsUnique();
            modelBuilder.Entity<BookEdition>().HasIndex(e => new { e.MediaType, e.Monitored, e.Status });
            modelBuilder.Entity<EditionFile>().HasIndex(f => f.Path).IsUnique();
            modelBuilder.Entity<CatalogImportBatch>().HasIndex(b => b.ExpiresAt);
            ...
            modelBuilder.Entity<History>().HasIndex(h => new { h.EditionId, h.Timestamp });
            modelBuilder.Entity<History>().HasIndex(h => new { h.MediaType, h.Timestamp });
