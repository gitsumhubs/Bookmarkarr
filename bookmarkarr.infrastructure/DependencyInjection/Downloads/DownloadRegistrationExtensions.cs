...
namespace Bookmarkarr.Infrastructure.DependencyInjection.Downloads;
...
internal static class DownloadRegistrationExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddSingleton<IDownloadClientQueueFetcher, ScopedDownloadClientQueueFetcher>();
        ...
        services.AddScoped<CollectionPassthroughImporter>();
