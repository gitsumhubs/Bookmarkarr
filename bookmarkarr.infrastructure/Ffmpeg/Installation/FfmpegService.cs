...
namespace Bookmarkarr.Infrastructure.Ffmpeg.Installation
{
    public partial class FfmpegService : IFfmpegService
    {
            ...
            IApplicationPathService applicationPathService)
        {
            ...
            var timeoutEnv = Environment.GetEnvironmentVariable("BOOKMARKARR_FFPROBE_DOWNLOAD_TIMEOUT_SECONDS");
            ...
            _autoInstall = Environment.GetEnvironmentVariable("BOOKMARKARR_AUTO_INSTALL_FFPROBE")?.ToLower() != "false"; // default true
        ...
        public async Task<string?> EnsureFfprobeInstalledAsync()
        {
            ...
            if (!_autoInstall)
            {
                _logger.LogInformation("Auto-install of ffprobe is disabled via BOOKMARKARR_AUTO_INSTALL_FFPROBE");
                return null;
            }
