...
namespace Bookmarkarr.Infrastructure.SystemDiagnostics.Diagnostics
{
    public class SystemService : ISystemService
    {
            ...
            try
            {
                ...
                if (!File.Exists(logFilePath))
                {
                    ...
                    logs.Add(new LogEntry
                    {
                        ...
                        Level = "Info",
                        Message = "Bookmarkarr application started",
                        Source = "Application"
                    });
                    logs.Add(new LogEntry
                    {
        ...
        public string GetLogFilePath()
        {
            ...
            // bookmarkarr.api/config/logs and production stays under the deployed root.
            ...
            // Serilog will create files like: bookmarkarr-20251105.log
            var logFileName = $"bookmarkarr-{DateTime.UtcNow:yyyyMMdd}.log";
            ...
            {
                var logFiles = Directory.GetFiles(logsDir, "bookmarkarr-*.log")
