...
public sealed class LocalFileSystem : IFileSystem
{
    ...
    public bool IsReparsePoint(string path)
    {
        ...
        // LinkTarget is reliable on Unix even where GetAttributes follows a
        // file symlink and omits ReparsePoint. Keep the attribute check for
        // Windows junctions and other reparse-point implementations.
