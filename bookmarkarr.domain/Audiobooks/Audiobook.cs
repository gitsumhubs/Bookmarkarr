...
namespace Bookmarkarr.Domain.Audiobooks
{
    public class Audiobook
    {
        ...
        /// <summary>Goodreads book identifier used for deterministic catalog imports.</summary>
        ...
        /// <summary>Independently monitored audiobook and ebook editions for this book.</summary>
