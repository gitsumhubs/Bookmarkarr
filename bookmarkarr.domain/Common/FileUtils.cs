...
namespace Bookmarkarr.Domain.Common
{
    public static partial class FileUtils
    {
        ...
        /// <summary>
        /// Ebook file extensions recognized by the ebook import pipeline.
        /// Comic archives are intentionally excluded so ebook mode cannot import
        /// unrelated comic-book releases.
        /// </summary>
        public static readonly HashSet<string> EbookExtensions = new(StringComparer.OrdinalIgnoreCase)
        {
