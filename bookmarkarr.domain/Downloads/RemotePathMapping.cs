...
{
    /// <summary>
    /// Represents a path mapping between a download client's path and Bookmarkarr's path.
    ...
    public class RemotePathMapping
    {
        ...
        /// <summary>
        /// The path as seen by the download client (e.g., "/downloads/bookmarkarr/")
        /// </summary>
        [Required]
        ...
        /// <summary>
        /// The path as seen by Bookmarkarr (e.g., "/server/downloads/complete/bookmarkarr/")
        /// </summary>
        [Required]
