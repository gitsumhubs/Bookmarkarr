...
namespace Bookmarkarr.Domain.Downloads
{
    ...
    public class Download
    {
        ...
        /// <summary>Authoritative edition link; null only for legacy/external queue items.</summary>
    ...
    public class QueueItem
    {
        ...
        /// <summary>Link to the independent audiobook or ebook edition.</summary>
        public int? EditionId { get; set; }

        /// <summary>Media discriminator used by edition-aware activity clients.</summary>
        ...
        /// <summary>
        /// The path translated for Bookmarkarr's filesystem (after applying remote path mapping)
        /// </summary>
        ...
        public int GetMatchScore(Download download)
        {
            ...
            // Once the download client has returned a stable external identifier,
            // that identifier is authoritative. Falling back to title matching for
            // a different queue/history ID can bind an older same-title attempt to
            // the current download and overwrite its correct client ID.
            if (!string.IsNullOrWhiteSpace(clientDownloadId) ||
