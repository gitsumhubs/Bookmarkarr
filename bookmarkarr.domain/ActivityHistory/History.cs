...
namespace Bookmarkarr.Domain.ActivityHistory
{
    ...
    public class History
    {
        ...
        /// <summary>The concrete audiobook or ebook edition involved in the event.</summary>
        public int? EditionId { get; set; }
        /// <summary>Stable media-type discriminator for edition-aware filtering.</summary>
        ...
        /// <summary>
        /// Bookmarkarr download record or external download identifier.
        /// </summary>
